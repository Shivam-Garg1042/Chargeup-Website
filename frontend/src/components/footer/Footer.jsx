    ...
    <footer className="bg-[#013c4c] text-[#F6F4F0]">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 px-6 py-8">
        ...
        <div>
          ...
          <ul>
            <li className="mb-2 hover:text-secondary cursor-pointer"><Link to="/about">About Us</Link></li>
            
            <li className="mb-2 hover:text-secondary cursor-pointer"><Link to="/">Home</Link></li>
