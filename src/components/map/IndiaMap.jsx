...
//     return (
//         <div className="py-6 w-full h-[610px] flex justify-center items-center  overflow-hidden relative">
//             <div className="absolute inset-0 opacity-20 pointer-events-none">
//         <Map className="absolute top-10 left-10 text-amber-300" size={100} />
//         <Compass className="absolute top-36 right-5 text-amber-300" size={120} />
//         <MapPin className="absolute bottom-1/2 left-1/2 text-amber-300" size={140} />
//         <PawPrint className="absolute top-100 left-10 text-amber-300" size={100} />
//         <Sparkle className="absolute top-1/2 right-1/3 text-amber-300" size={120} />
//         <Route className="absolute bottom-1/5 left-1/8 text-amber-300" size={140} />
//       </div>
//             {mapData ? (
//                 <HighchartsReact
